...
public class RedisUtils {
	...
	public static byte[] dump(String key) {
		return redisUtils.redisTemplate.dump(key);
	}
	...
	public static  Boolean move(String key, int dbIndex) {
		return redisUtils.redisTemplate.move(key, dbIndex);
	}
	...
	public static  Long getExpire(String key, TimeUnit unit) {
		return redisUtils.redisTemplate.getExpire(key, unit);
	}
	...
	public static  String getRange(String key, long start, long end) {
		return redisUtils.redisTemplate.opsForValue().get(key, start, end);
	}
	...
	public static  String getAndSet(String key, String value) {
		return redisUtils.redisTemplate.opsForValue().getAndSet(key, value);
	}
	...
	public static  Boolean getBit(String key, long offset) {
		return redisUtils.redisTemplate.opsForValue().getBit(key, offset);
	}
	...
	public static  List<String> multiGet(Collection<String> keys) {
		return redisUtils.redisTemplate.opsForValue().multiGet(keys);
	}
	...
	public static  boolean setBit(String key, long offset, boolean value) {
		return redisUtils.redisTemplate.opsForValue().setBit(key, offset, value);
	}
	...
	public static  void setEx(String key, String value, long timeout, TimeUnit unit) {
		redisUtils.redisTemplate.opsForValue().set(key, value, timeout, unit);
	}
	...
	public static  boolean setIfAbsent(String key, String value) {
		return redisUtils.redisTemplate.opsForValue().setIfAbsent(key, value);
	}
	...
	public static  void setRange(String key, String value, long offset) {
		redisUtils.redisTemplate.opsForValue().set(key, value, offset);
	}
	...
	public static  Long size(String key) {
		return redisUtils.redisTemplate.opsForValue().size(key);
	}
	...
	public static  void multiSet(Map<String, String> maps) {
		redisUtils.redisTemplate.opsForValue().multiSet(maps);
	}
	...
	public static  boolean multiSetIfAbsent(Map<String, String> maps) {
		return redisUtils.redisTemplate.opsForValue().multiSetIfAbsent(maps);
	}
	...
	public static  Long incrBy(String key, long increment) {
		return redisUtils.redisTemplate.opsForValue().increment(key, increment);
	}
	...
	public static  Integer append(String key, String value) {
		return redisUtils.redisTemplate.opsForValue().append(key, value);
	}
	...
	public static  List<Object> hMultiGet(String key, Collection<Object> fields) {
		return redisUtils.redisTemplate.opsForHash().multiGet(key, fields);
	}
	...
	public static  void hPutAll(String key, Map<String, String> maps) {
		redisUtils.redisTemplate.opsForHash().putAll(key, maps);
	}
	...
	public static  Boolean hPutIfAbsent(String key, String hashKey, String value) {
		return redisUtils.redisTemplate.opsForHash().putIfAbsent(key, hashKey, value);
	}
	...
	public static  Long hDelete(String key, Object... fields) {
		return redisUtils.redisTemplate.opsForHash().delete(key, fields);
	}
	...
	public static  Long hIncrBy(String key, Object field, long increment) {
		return redisUtils.redisTemplate.opsForHash().increment(key, field, increment);
	}
	...
	public static  Double hIncrByFloat(String key, Object field, double delta) {
		return redisUtils.redisTemplate.opsForHash().increment(key, field, delta);
	}
	...
	public static  Set<Object> hKeys(String key) {
		return redisUtils.redisTemplate.opsForHash().keys(key);
	}
	...
	public static  List<Object> hValues(String key) {
		return redisUtils.redisTemplate.opsForHash().values(key);
	}
	...
	public static  Cursor<Entry<Object, Object>> hScan(String key, ScanOptions options) {
		return redisUtils.redisTemplate.opsForHash().scan(key, options);
	}
	...
	public static  Long lLeftPush(String key, String value) {
		return redisUtils.redisTemplate.opsForList().leftPush(key, value);
	}
	...
	public static  Long lLeftPushAll(String key, String... value) {
		return redisUtils.redisTemplate.opsForList().leftPushAll(key, value);
	}
	...
	public static  Long lLeftPushIfPresent(String key, String value) {
		return redisUtils.redisTemplate.opsForList().leftPushIfPresent(key, value);
	}
	...
	public static  Long lLeftPush(String key, String pivot, String value) {
		return redisUtils.redisTemplate.opsForList().leftPush(key, pivot, value);
	}
	...
	public static  Long lRightPush(String key, String value) {
		return redisUtils.redisTemplate.opsForList().rightPush(key, value);
	}
	...
	public static  Long lRightPushAll(String key, String... value) {
		return redisUtils.redisTemplate.opsForList().rightPushAll(key, value);
	}
	...
	public static  Long lRightPushIfPresent(String key, String value) {
		return redisUtils.redisTemplate.opsForList().rightPushIfPresent(key, value);
	}
	...
	public static  Long lRightPush(String key, String pivot, String value) {
		return redisUtils.redisTemplate.opsForList().rightPush(key, pivot, value);
	}
	...
	public static  String lBLeftPop(String key, long timeout, TimeUnit unit) {
		return redisUtils.redisTemplate.opsForList().leftPop(key, timeout, unit);
	}
	...
	public static  String lBRightPop(String key, long timeout, TimeUnit unit) {
		return redisUtils.redisTemplate.opsForList().rightPop(key, timeout, unit);
	}
	...
	public static  String lRightPopAndLeftPush(String sourceKey, String destinationKey) {
		return redisUtils.redisTemplate.opsForList().rightPopAndLeftPush(sourceKey,
				destinationKey);
	}
	...
	public static  Long lRemove(String key, long index, String value) {
		return redisUtils.redisTemplate.opsForList().remove(key, index, value);
	}
	...
	public static  void lTrim(String key, long start, long end) {
		redisUtils.redisTemplate.opsForList().trim(key, start, end);
	}
	...
	public static  String sPop(String key) {
		return redisUtils.redisTemplate.opsForSet().pop(key);
	}
	...
	public static  Boolean sMove(String key, String value, String destKey) {
		return redisUtils.redisTemplate.opsForSet().move(key, value, destKey);
	}
	...
	public static  Set<String> sIntersect(String key, String otherKey) {
		return redisUtils.redisTemplate.opsForSet().intersect(key, otherKey);
	}
	...
	public static  Set<String> sIntersect(String key, Collection<String> otherKeys) {
		return redisUtils.redisTemplate.opsForSet().intersect(key, otherKeys);
	}
	...
	public static  Long sIntersectAndStore(String key, String otherKey, String destKey) {
		return redisUtils.redisTemplate.opsForSet().intersectAndStore(key, otherKey,
				destKey);
	}
	...
	public static  Long sIntersectAndStore(String key, Collection<String> otherKeys,
			String destKey) {
		return redisUtils.redisTemplate.opsForSet().intersectAndStore(key, otherKeys,
				destKey);
	}
	...
	public static  Set<String> sUnion(String key, String otherKeys) {
		return redisUtils.redisTemplate.opsForSet().union(key, otherKeys);
	}
	...
	public static  Long sUnionAndStore(String key, String otherKey, String destKey) {
		return redisUtils.redisTemplate.opsForSet().unionAndStore(key, otherKey, destKey);
	}
	...
	public static  Long sUnionAndStore(String key, Collection<String> otherKeys,
			String destKey) {
		return redisUtils.redisTemplate.opsForSet().unionAndStore(key, otherKeys, destKey);
	}
	...
	public static  Set<String> sDifference(String key, String otherKey) {
		return redisUtils.redisTemplate.opsForSet().difference(key, otherKey);
	}
	...
	public static  Set<String> sDifference(String key, Collection<String> otherKeys) {
		return redisUtils.redisTemplate.opsForSet().difference(key, otherKeys);
	}
	...
	public static  Long sDifference(String key, String otherKey, String destKey) {
		return redisUtils.redisTemplate.opsForSet().differenceAndStore(key, otherKey,
				destKey);
	}
	...
	public static  Long sDifference(String key, Collection<String> otherKeys,
			String destKey) {
		return redisUtils.redisTemplate.opsForSet().differenceAndStore(key, otherKeys,
				destKey);
	}
	...
	public static  String sRandomMember(String key) {
		return redisUtils.redisTemplate.opsForSet().randomMember(key);
	}
	...
	public static  List<String> sRandomMembers(String key, long count) {
		return redisUtils.redisTemplate.opsForSet().randomMembers(key, count);
	}
	...
	public static  Set<String> sDistinctRandomMembers(String key, long count) {
		return redisUtils.redisTemplate.opsForSet().distinctRandomMembers(key, count);
	}
	...
	public static  Cursor<String> sScan(String key, ScanOptions options) {
		return redisUtils.redisTemplate.opsForSet().scan(key, options);
	}
	...
	public static  Long zAdd(String key, Set<TypedTuple<String>> values) {
		return redisUtils.redisTemplate.opsForZSet().add(key, values);
	}
	...
	public static  Long zRemove(String key, Object... values) {
		return redisUtils.redisTemplate.opsForZSet().remove(key, values);
	}
	...
	public static  Double zIncrementScore(String key, String value, double delta) {
		return redisUtils.redisTemplate.opsForZSet().incrementScore(key, value, delta);
	}
	...
	public static  Long zRank(String key, Object value) {
		return redisUtils.redisTemplate.opsForZSet().rank(key, value);
	}
	...
	public static  Long zReverseRank(String key, Object value) {
		return redisUtils.redisTemplate.opsForZSet().reverseRank(key, value);
	}
	...
	public static  Set<String> zRange(String key, long start, long end) {
		return redisUtils.redisTemplate.opsForZSet().range(key, start, end);
	}
	...
	public static  Set<TypedTuple<String>> zRangeWithScores(String key, long start,
			long end) {
		return redisUtils.redisTemplate.opsForZSet().rangeWithScores(key, start, end);
	}
	...
	public static  Set<String> zRangeByScore(String key, double min, double max) {
		return redisUtils.redisTemplate.opsForZSet().rangeByScore(key, min, max);
	}
	...
	public static  Set<TypedTuple<String>> zRangeByScoreWithScores(String key,
		...
		return redisUtils.redisTemplate.opsForZSet().rangeByScoreWithScores(key, min, max);
	}
	...
	public static  Set<String> zReverseRange(String key, long start, long end) {
		return redisUtils.redisTemplate.opsForZSet().reverseRange(key, start, end);
	}
	...
	public static  Set<TypedTuple<String>> zReverseRangeWithScores(String key,
			long start, long end) {
		return redisUtils.redisTemplate.opsForZSet().reverseRangeWithScores(key, start,
				end);
	}
	...
	public static  Set<String> zReverseRangeByScore(String key, double min,
			double max) {
		return redisUtils.redisTemplate.opsForZSet().reverseRangeByScore(key, min, max);
	}
	...
	public static  Set<TypedTuple<String>> zReverseRangeByScoreWithScores(
		...
		return redisUtils.redisTemplate.opsForZSet().reverseRangeByScoreWithScores(key,
				min, max);
	}
	...
	public static  Long zCount(String key, double min, double max) {
		return redisUtils.redisTemplate.opsForZSet().count(key, min, max);
	}
	...
	public static  Long zSize(String key) {
		return redisUtils.redisTemplate.opsForZSet().size(key);
	}
	...
	public static  Long zZCard(String key) {
		return redisUtils.redisTemplate.opsForZSet().zCard(key);
	}
	...
	public static  Long zRemoveRange(String key, long start, long end) {
		return redisUtils.redisTemplate.opsForZSet().removeRange(key, start, end);
	}
	...
	public static  Long zRemoveRangeByScore(String key, double min, double max) {
		return redisUtils.redisTemplate.opsForZSet().removeRangeByScore(key, min, max);
	}
	...
	public static  Long zUnionAndStore(String key, String otherKey, String destKey) {
		return redisUtils.redisTemplate.opsForZSet().unionAndStore(key, otherKey, destKey);
	}
	...
	public static  Long zUnionAndStore(String key, Collection<String> otherKeys,
			String destKey) {
		return redisUtils.redisTemplate.opsForZSet()
	...
	public static  Long zIntersectAndStore(String key, String otherKey,
			String destKey) {
		return redisUtils.redisTemplate.opsForZSet().intersectAndStore(key, otherKey,
				destKey);
	}
	...
	public static  Long zIntersectAndStore(String key, Collection<String> otherKeys,
			String destKey) {
		return redisUtils.redisTemplate.opsForZSet().intersectAndStore(key, otherKeys,
				destKey);
	}
	...
	public static  Cursor<TypedTuple<String>> zScan(String key, ScanOptions options) {
		return redisUtils.redisTemplate.opsForZSet().scan(key, options);
	}
