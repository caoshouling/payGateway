...
{ 
    ...
    throws Exception
  {
    ...
    //私钥加密
    String encrypted_pwssword = encrypt(privateKey, password);
    
    System.out.println("加密后的密码:" + encrypted_pwssword);
    //公钥解密
    System.out.println("publicKey解密后的密码:" + decrypt(publicKey,encrypted_pwssword));
  }
